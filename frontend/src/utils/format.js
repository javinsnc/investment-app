export const fmtCurrency = new Intl.NumberFormat("es-ES", {
    style: "currency",
    currency: "EUR",
    maximumFractionDigits: 2
});
export const fmtCurrencyCompact = new Intl.NumberFormat("es-ES", {
    style: "currency",
    currency: "EUR",
    notation: "compact",
...
export const formatByType = (type, value) => {
    ...
    switch ((type || "").toLowerCase()) {
        case "forex":
            return new Intl.NumberFormat("es-ES", {minimumFractionDigits: 4, maximumFractionDigits: 4}).format(value);
        case "crypto":
            return new Intl.NumberFormat("es-ES", {minimumFractionDigits: 6, maximumFractionDigits: 8}).format(value);
        default:
